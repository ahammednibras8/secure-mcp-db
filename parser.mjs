...
function findWasmBinary() {
  ...
  return new URL('parser.wasm', import.meta.url).href;
...
var _parse_sql = Module['_parse_sql'] = makeInvalidEarlyAccess('_parse_sql');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['parse_sql'] != 'undefined', 'missing Wasm export: parse_sql');
  ...
  _parse_sql = Module['_parse_sql'] = createExportWrapper('parse_sql', 2);
